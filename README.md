...
<img width="685" alt="Снимок экрана 2025-06-03 в 22 24 41" src="https://github.com/user-attachments/assets/9c9be454-7b9b-4e42-bf5d-72e4aa852732" />
...
Домен безопасности
Уровень доверия
Оценка сложности и размера
Обоснование
Пассажир
Недоверенная сущность
[S, S]
Внешний пользователь, неизвестные и потенциально вредоносные действия.
Сканер биометрии
Доверенная+ (целостность)
[C, L]
Критичен для идентификации; требует защиты от подделки и вмешательства.
Локальный журнал
Доверенная сущность
[M, L]
Хранит критичные логи; важна неизменность и локальная доступность.
Центральная система управления
Доверенная сущность
[C, L]
Обрабатывает команды, обеспечивает управление дверями, требует точности.
Автономный модуль
Доверенная сущность
[M, L]
Обеспечивает офлайн-работу; средний уровень сложности и требований.
Банк
Доверенная+ (высокая целостность)
[C, XL]
Внешний сервис, критически важный для платежей, высокий уровень защиты.
Двери
Недоверенная сущность
[S, S]
Простое механическое устройство, подвержено физическим воздействиям.
